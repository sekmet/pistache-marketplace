...
export declare namespace NFTMarketBase {
...
export interface NFTMarketBaseInterface extends utils.Interface {
  functions: {
...
export interface NFTMarketBase extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: NFTMarketBaseInterface;
  ...
  functions: {
    ...
    ): Promise<[NFTMarketBase.MarketItemStructOutput[]]>;
