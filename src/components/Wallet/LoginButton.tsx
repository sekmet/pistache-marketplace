    ...
    return (
      <div>
        <a
          ...
          className="group flex w-full items-center rounded-lg border-2 bg-gray-50 p-3 text-left text-base font-bold text-gray-900 hover:bg-gray-100 hover:shadow dark:bg-gray-600 dark:text-white dark:hover:bg-gray-500"
        >
          <svg
            className="h-4"
            viewBox="0 0 40 38"
          ...
          <span className="ml-3 inline-flex items-center justify-center rounded bg-green-600 py-0.5 px-2 text-xs font-medium text-white dark:bg-green-500 dark:text-gray-400">
            Popular
          </span>
        </a>
      </div>
    ...
    return (
      <div className="text-left">
        <a
          href="#"
          onClick={() => connect({ connector })}
          className="group flex items-center rounded-lg border-2 bg-gray-50 p-3 text-base font-bold text-gray-900 hover:bg-gray-100 hover:shadow dark:bg-gray-600 dark:text-white dark:hover:bg-gray-500"
        >
          <svg
            className="h-5"
            viewBox="0 0 292 292"
