...
const Index = ({ items }: Props) => {
  ...
  const importFunctionHandler = () => {
    router.push('/newsecret');
  }; */
  ...
  return (
    ...
    >
      ...
      <div className="min-w-0 flex-1 bg-white xl:flex">
        {/* Account profile */}
        <div className="bg-white xl:w-64 xl:shrink-0 xl:border-r xl:border-gray-200">
        ...
        <div className="bg-white lg:min-w-0 lg:flex-1">
          <div className="border-y border-gray-200 py-4 pl-4 pr-6 sm:pl-6 lg:pl-8 xl:border-t-0 xl:pl-6 xl:pt-6">
