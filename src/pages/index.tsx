                  ...
                  <div className="flex-1 space-y-8">
                    <div className="space-y-8 sm:flex sm:items-center sm:justify-between sm:space-y-0 xl:block xl:space-y-8">
                      ...
                      <div className="flex items-center space-x-3">
                        ...
                        <span className="h-12 w-12 rounded-full">
                              <Identicon accountId={'0xFf0573b826A3120df03Cb6F1eC0B5992a9948472'} iconSize={48} />
                            </span>
                        </div>
                        <div className="space-y-1">
                          <div className="text-sm font-medium text-gray-900">Carlos Guimaraes</div>
                    ...
                    <div className="flex flex-col space-y-6 sm:flex-row sm:space-y-0 sm:space-x-8 xl:flex-col xl:space-x-0 xl:space-y-6">
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        <span className="text-sm font-medium text-gray-500">8 Functions</span>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="bg-white lg:min-w-0 lg:flex-1">
              <div className="border-b border-t border-gray-200 pl-4 pr-6 pt-4 pb-4 sm:pl-6 lg:pl-8 xl:border-t-0 xl:pl-6 xl:pt-6">
                <div className="flex items-center">
                  <h1 className="flex-1 text-lg font-medium">Web3 Functions</h1>
