...
export default function Newfunction() {
  ...
  >
    ...
    <div className="lg:grid lg:grid-cols-12 lg:gap-x-5">
      <aside className="py-6 px-2 sm:px-6 lg:col-span-3 lg:py-0 lg:px-0 lg:mt-6">
      ...
      <div className="space-y-6 sm:px-6 lg:col-span-9 lg:px-0">
        <form action="#" method="POST">
          <div className="shadow sm:overflow-hidden sm:rounded-md">
            <div className="space-y-6 bg-white py-6 px-4 sm:p-6">
              <div>
                <h3 className="text-lg font-medium leading-6 text-gray-900">Web3 Function</h3>
              ...
              <div className="grid grid-cols-3 gap-6">
                ...
                <div className="col-span-3">
                  <div>
                    <CodeEditor sourcecode={functionMockup} />
                    {/**/}
                  </div>
        ...
        <form action="#" method="POST">
          <div className="shadow sm:overflow-hidden sm:rounded-md">
            <div className="space-y-6 bg-white py-6 px-4 sm:p-6">
              <div>
                <h3 className="text-lg font-medium leading-6 text-gray-900">Schema JSON Information</h3>
                <p className="mt-1 text-sm text-gray-500">Define you schema json for your web3 function</p>
              </div>

              <div className="grid grid-cols-6 gap-6">
                <div className="col-span-6">
                  <label htmlFor="web3FunctionVersion" className="block text-sm font-medium text-gray-700">
                ...
                <div className="col-span-6">
                  <label htmlFor="userArgs" className="block text-sm font-medium text-gray-700">
                   User Arguments
                  </label>
                  <textarea
                      id="userArgs"
